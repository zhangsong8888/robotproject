...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_calibration_SOURCE_PREFIX /home/nvidia/turbot/src/turtlebot_apps/turtlebot_calibration)
  set(turtlebot_calibration_DEVEL_PREFIX /home/nvidia/turbot/devel)
  ...
  set(turtlebot_calibration_INSTALL_PREFIX /home/nvidia/turbot/install)
...
if(NOT "/home/nvidia/turbot/devel/include " STREQUAL " ")
  set(turtlebot_calibration_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/turbot/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/turbot/src/turtlebot_apps/turtlebot_calibration/${idir}'.  ${_report}")
    endif()
