...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_follower_SOURCE_PREFIX /home/nvidia/turbot/src/turtlebot_apps/turtlebot_follower)
  set(turtlebot_follower_DEVEL_PREFIX /home/nvidia/turbot/devel)
  ...
  set(turtlebot_follower_INSTALL_PREFIX /home/nvidia/turbot/install)
...
if(NOT "/home/nvidia/turbot/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/turbot/src/turtlebot_apps/turtlebot_follower/${idir}'.  ${_report}")
    endif()
